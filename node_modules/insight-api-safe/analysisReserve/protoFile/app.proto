...
message ExtendData {                    //103
    required bytes version = 1;         // uint16_t
    required uint32 auth = 2;           // uint32_t
    required bytes extendData = 3;      // string
}

message IssueData {                     //200
    required bytes version = 1;             // uint16_t
...
message CommonData { // for add issue, transfer, destory  201 202 203 204
    required bytes version = 1;             // uint16_t
...
message TransferSafeData {                  //
    required bytes version = 1;             // uint16_t
    required bytes remarks = 2;             // string
}
