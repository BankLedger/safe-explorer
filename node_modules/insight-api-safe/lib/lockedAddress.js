...
LockedAddressController.prototype.addressList = function (req, res) {
    ...
    if (option.order.length > 4 || option.assetName.length > 20 || isNaN(option.start)) {
        return self.common.handleErrors({message: "params error！"}, res);
    }
...
LockedAddressController.prototype.transactionList = function (req, res) {
    ...
    if (option.start < 0 || option.assetName > 20 || isNaN(option.start)) {
        return self.common.handleErrors({message: "params error！"}, res);
    }
...
LockedAddressController.prototype.getLockedAssetNameList = function (req, res) {
    ...
    // if (this.checkParams({assetName: assetName})) {
    //     return self.common.handleErrors({message: "params error！"}, res);
    // }
...
LockedAddressController.prototype.lockedDetailByAddress = function (req, res) {
    ...
    if (option.assetName > 20 || option.address > 34 || option.order.length > 4 || isNaN(option.start)) {
        return self.common.handleErrors({message: "params error！"}, res);
    }
...
LockedAddressController.prototype.checkParams = function (params) {
