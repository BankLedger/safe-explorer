...
<head>
    ...
    <meta name="keywords"
          content="bitcoins, transactions, blocks, address, block chain, best block, mining difficulty, hash serialized">
    <meta name="description"
          content="Safe Insight. View detailed information on all safe transactions and block. {{ $root.title + $root.titleDetail }}">
...
<div id="wrap">
    <div class="navbar navbar-default navbar-fixed-top" data-ng-include="'views/includes/header.html'"
         role='navigation'></div>
    <section class="container" data-ng-view></section>
</div>
<div id="footer" role="navigation">
    <div class="container">
        <div style="text-align:center;margin-top:15px;font-size:14px;" class="hidden-xs">
            <div> © 2018-2022 SAFE Foundation All rights reserved　　Contact Us ：support@anwang.com
            </div>
        </div>

        <div class="footer visible-xs" >
            @2018 SAFE Foundation all rights reserved<br>
            Contact Us ：support@anwang.com
        </div>
    </div>
</div>
...
<script src="js/angular-echarts.min.js"></script>
