...
function $CompileProvider($provide, $$sanitizeUriProvider) {
  ...
  this.$get = [
    ...
    Attributes.prototype = {
       ...
       *
       * @description
       * Converts an attribute name (e.g. safe/colon/underscore-delimited string, optionally prefixed with `x-` or
...
var NgModelController = ['$scope', '$exceptionHandler', '$attrs', '$element', '$parse', '$animate',
   ...
   *        The `validationErrorKey` should be in camelCase and will get converted into safe-case
