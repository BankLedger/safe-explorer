...
<section data-ng-controller="BlocksController" data-ng-init="list()">
    ...
    <div class="row">
        <div class="col-xs-12 col-gray col-gray-fixed">
            <div class="block-id" style="margin-top:50px;">
            ...
            <p class="lead text-center m20v">
                ...
                <a href="#" class="btn btn-primary btn-xs" datepicker-popup show-button-bar="false"
                   data-ng-click="openCalendar($event)" data-ng-model="dt" is-open="opened"
            ...
            <div data-ng-if="pagination.current">
                ...
                <div class="text-center" style="margn-top:50px; margin-bottom: 20px;">
        ...
        <div class="col-xs-12 col-md-9 col-md-offset-3">
            ...
            <div data-ng-if="pagination.more">
                <a class="btn btn-primary" href="blocks-date/{{pagination.current}}" data-ng-show="before" translate>
                    Lastest block from date</a>
                <a class="btn btn-primary" href="blocks-date/{{pagination.current}}/{{pagination.moreTs}}" translate>
                    Older blocks from this date</a>
            </div>
        </div>
    </div>
    <div data-ng-show="!blocks.length && !loading">
