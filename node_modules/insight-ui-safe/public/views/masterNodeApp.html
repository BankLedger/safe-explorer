...
<!-- 这是APP打开的界面，不是手机浏览器打开的界面。  -->
<div data-ng-controller="MastrtnodeMobileController" data-ng-init="read()">
    ...
    <div class="row">
        <div class="col-xs-12 col-md-11 ">
            <div class=" form-group" style="margin-top: 30px">
                <h1>
                    <span class="navbar-left col-xs-12" translate>Masternodes APP</span>
                </h1>
                <div class="col-xs-12" style="margin-top:15px">
                    ...
                    <div class="navbar-left col-xs-4" style="margin-top: -15px">
                        <!--<button class="btn btn-default" style="border-radius: 50%; height: 80px; background-color: #ffffff;">{{rate}}% 正常</button>-->
                ...
                <table style="table-layout:fixed" class="table table-hover table-striped tab-content">
                    ...
                    <tr class="fader" data-ng-repeat='m in masternode'>
                        ...
                        <td class="text-right">
                            <img src="./img/icon/no_follow.png" width="40px" data-ng-show="!isFollow && !m.beforeFollow" data-ng-click="addMasterNodeForMobile(m)" />
                            <img src="./img/icon/follow_add.png" width="40px" data-ng-show="!isFollow && m.beforeFollow" data-ng-click="removeMasterNodeForMobile(m)"/>
                            <img src="./img/icon/follow_del.png" width="40px" data-ng-show="isFollow" data-ng-click="removeMasterNodeForMobile(m)"/>
                        </td>
                    </tr>
                    </tbody>
                </table>
