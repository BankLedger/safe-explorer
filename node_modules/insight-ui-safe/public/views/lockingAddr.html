...
<section data-ng-controller="lockedAddressController" data-ng-init="LockedAddressList(1,'true')">
    ...
    <ul class="nav nav-tabs visible-xs" style="padding-top:20px;">
        <li class="{{addressLockedTabClass}}" data-ng-click="LockedAddressList(1,'true')" style="width: 50%">
            <a data-toggle="tab" translate>Locked Address</a>
        </li>
        <li class="{{txLockedListTabClass}}" data-ng-click="LockedTransactionList(1,'true')" style="width: 50%">
            <a data-toggle="tab" translate>Locked Transaction</a>
        </li>
    </ul>
    <!-- mobile search start -->
