...
<section data-ng-controller="BlocksController" data-ng-init="findOne()">
    ...
    <div class="secondary_navbar hidden-xs hidden-sm" scroll data-ng-class="{'hidden': !secondaryNavbar}"
        ...
        <div class="container" data-ng-if="!hideSNavbar">
            <div class="row">
                <div class="col-md-1">
                    <a href="block/{{block.previousblockhash}}"><span
                            class="lead glyphicon glyphicon-chevron-left"></span></a>
                </div>
                <div class="col-md-10">
                    <div class="row">
                        <div class="col-md-5">
            ...
            <div class="col-md-6">
                <table class="table" style="table-layout: fixed">
                    ...
                    <tr data-ng-show="block.previousblockhash">
                        ...
                        <td data-ng-show="block.height > 1" class="text-right"><a href="block/{{block.previousblockhash}}">{{block.height-1}}</a></td>
                    </tr>
                    </tbody>
                </table>
            </div>
