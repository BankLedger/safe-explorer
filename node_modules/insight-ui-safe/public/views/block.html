            ...
            <div class="row">
                <div class="col-md-1">
                    <a href="block/{{block.previousblockhash}}">
                        <span class="lead glyphicon glyphicon-chevron-left"></span>
                    </a>
                </div>
                <div class="col-md-10">
                    <div class="row">
                ...
                <div class="col-md-1">
                    <a data-ng-show="block.nextblockhash" href="block/{{block.nextblockhash}}">
                        <span class="lead glyphicon glyphicon-chevron-right"></span>
                    </a>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <table class="table" style="table-layout: fixed">
                    ...
                    <tr>
                        ...
                        <td class="text-right text-muted">{{$root.currency.getConvertion(block.reward) || block.reward +
                            ' SAFE'}}
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr data-ng-show="block.previousblockhash">
                        ...
                        <td data-ng-show="block.height == 1" class="text-right"><span>{{block.height-1}}</span></td>
                        <td data-ng-show="block.height > 1" class="text-right"><a
                                href="block/{{block.previousblockhash}}">{{block.height-1}}</a></td>
                    </tr>
                    </tbody>
                </table>
            </div>
