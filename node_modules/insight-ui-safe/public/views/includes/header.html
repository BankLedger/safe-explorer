<div class="container col-xs-12 col-md-12 col-lg-11">
  <div data-ng-controller="HeaderController" class=" col-lg-offset-1">
    <div class="navbar-header">
      ...
      <div>
        <a class="insight navbar-brand" href="." style="margin-top: 5px;">
          <!--<img src="./img/SAFElogo_white.png" style="width: 200px; height: auto;margin-top: -15px;" alt="safe_logo">-->
          <img src="./img/SAFElogo_white.png" style="width: 200px; height: auto;" alt="safe_logo">
        </a>
      </div>
    </div>
    <div class="navbar-collapse collapse" collapse="$root.isCollapsed">
      <ul class="nav navbar-nav" >
        <li data-ng-repeat="item in menu" ui-route="{{item.link}}" data-ng-class="{active: $uiRoute}">
          <a href="{{item.link}}" data-ng-click="$root.isCollapsed = true">{{item.title|translate}}</a>
        </li>
      </ul>
      ...
      <div class="status" data-ng-controller="StatusController">
        ...
        <li class="dropdown" data-ng-controller="FooterController" data-ng-include="'views/includes/luangChange.html'"></li>
      </ul>
    </div>
      </li>
      </ul>
