    ...
    <div class="row">
        <div class="col-xs-12 col-md-12 " style="height:690px;">
            ...
            <div class="row form-group" style="margin-top: 30px;">
                <h1>
                    <span class="navbar-left col-xs-3" translate>Masternodes</span>
                </h1>

                <div class="navbar-left col-xs-4">
                ...
                <div class="navbar-left col-xs-2" style="margin-top: -15px">
                ...
                <div class="navbar-left col-xs-3" style="font-size:2.5rem">
