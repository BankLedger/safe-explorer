...
<section data-ng-controller="AssetsController" data-ng-init="findOne()">
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table" style="word-break: break-all;word-wrap: break-word;">
                    <tbody>
                    <tr>
                        <td class="col-md-1"><strong translate>Asset Id</strong></td>
    ...
    <div class="visible-xs">
        ...
        <ul class="device_ul">
            ...
            <li>
                <div class="device_name"><strong translate>Destroyed</strong></div>
            ...
            <li>
                <div class="device_name"><strong translate>Asset Id</strong></div>
                <div class="device_box text-muted">{{id}}</div>
            </li>
