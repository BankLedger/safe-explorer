  ...
  <div class="container">
    <div id="home" class="row">
      <div class="col-xs-12 col-md-12">
        ...
        <h1 >
          <span translate>Latest Blocks</span> 
          <a id="safeTotal" href="statistic"><span translate>Circulation Supply of SAFE</span>:{{ flowAmount }}</a>
        </h1>
        ...
        <table class="table table-hover table-striped" style="table-layout: fixed;">
          ...
          <tr class="fader" data-ng-repeat='tx in txs'>
            ...
            <td class="text-right"><span class="ellipsis">{{$root.currency.getConvertion(tx.valueOut) || tx.valueOut + tx.assetId}}</span></td>
          </tr>
          </tbody>
        </table>
      </div>
