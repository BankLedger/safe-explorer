...
MysqlUtils.prototype.getAddressCount = function (params, cb) {
    var sql = "SELECT count(*) as count FROM(SELECT id FROM " + params.tableName + params.where + " GROUP BY address) a";
    this.sql(sql, [], cb);
};
...
MysqlUtils.prototype.getTransactionCount = function (params, cb) {
    var sql = "SELECT count(*) as count FROM " + params.tableName + params.where;
    this.sql(sql, [], cb);
};
