...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --daemon', 'Make bitcore-node-safe a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bitcore-node-safe create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bitcore-node-safe add wallet-service');
      console.log('    $ bitcore-node-safe add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bitcore-node-safe remove wallet-service');
      console.log('    $ bitcore-node-safe remove insight-api');
      console.log();
    });
